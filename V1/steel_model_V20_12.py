...
BASE_DIR = r"C:/Users/Bruna/OneDrive/DOUTORADO/0.TESE/modelagem/steel_location_model/steel_location/V1"
...
#
# Standalone section: does not modify plot_all(). Call after extract_results():
#     plot_production_by_state(results, cfg, OUTPUT_DIR)
# ----------------------------------------------------------------------------
 
def plot_production_by_state(results: dict,
                             cfg: dict,
                             output_dir: str,
                             min_kt: float = 1.0,
    ...
    min_kt : states whose peak annual production never reaches this value are
             dropped, so the legend does not fill up with empty states.
    """
    import os
    import pandas as pd
    import matplotlib.pyplot as plt
    ...
    # Drop negligible states, keep the largest at the bottom of the stack
